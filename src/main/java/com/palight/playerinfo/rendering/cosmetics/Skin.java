...
public class Skin {
    ...
    public Skin(String uuid, int totalFrames, int fps, boolean animated) {
        this.uuid = uuid;
    ...
    public String toString() {
        return String.format("SKIN[uuid=%s,fps=%d,frames=%d,animated=%b]", this.uuid, this.getFPS(), this.getTotalFrames(), this.isAnimated());
    }
}
