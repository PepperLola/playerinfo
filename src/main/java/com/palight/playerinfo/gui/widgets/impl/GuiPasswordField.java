...
public class GuiPasswordField extends Gui {
    ...
    public GuiPasswordField(int id, FontRenderer fontRendererInstance, int x, int y, int w, int h) {
        this.id = id;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            boolean lvt_5_1_ = lvt_2_1_ >= 0 && lvt_2_1_ <= trimmedString.length();
            ...
            if (lvt_3_1_ > trimmedString.length()) {
                lvt_3_1_ = trimmedString.length();
            }

            if (trimmedString.length() > 0) {
                String lvt_10_1_ = lvt_5_1_ ? trimmedString.substring(0, lvt_2_1_) : trimmedString;
                lvt_9_1_ = this.fontRendererInstance.drawStringWithShadow(StringUtils.repeat("*", lvt_10_1_.length()), (float)lvt_7_1_, (float)lvt_8_1_, color);
            }
            ...
            if (trimmedString.length() > 0 && lvt_5_1_ && lvt_2_1_ < trimmedString.length()) {
                lvt_9_1_ = this.fontRendererInstance.drawStringWithShadow(StringUtils.repeat("*", trimmedString.substring(lvt_2_1_).length()), (float)lvt_9_1_, (float)lvt_8_1_, color);
            }
            ...
            if (lvt_6_1_) {
                if (lvt_10_2_) {
                    ...
                    this.fontRendererInstance.drawStringWithShadow("_", (float)lvt_11_1_, (float)lvt_8_1_, color);
                }
            }

            if (lvt_3_1_ != lvt_2_1_) {
                int lvt_12_1_ = lvt_7_1_ + this.fontRendererInstance.getStringWidth(trimmedString.substring(0, lvt_3_1_));
