...
public class ScoreboardGui extends CustomGuiScreenScrollable {
    ...
    public void initGui() {
        ...
        resetPositionButton = new GuiButton(3, buttonX, buttonY + 48,  48, 20, "Reset Position");
        int buttonWidth = (xSize - 3 * leftOffset - 2) / 3;
        int buttonLeft = guiX + leftOffset + 2;
        primaryColorButton = new GuiButton(4, buttonLeft, guiY + ySize - 22,  buttonWidth, 20, "Primary");
        secondaryColorButton = new GuiButton(5, buttonLeft + buttonWidth, guiY + ySize - 22, buttonWidth, 20, "Secondary");
        resetColorsButton = new GuiButton(6, buttonLeft + 2 * buttonWidth, guiY + ySize - 22, buttonWidth, 20, "Reset");
    ...
    protected void widgetClicked(GuiCustomWidget widget) {
        ...
        } else if (widget.id == resetPositionButton.id) {
            ((ScoreboardWidget) module.getWidget()).resetPosition();
